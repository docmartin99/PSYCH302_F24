...
```{r}
quantile(wrong_site$Wrong_Patient, .25)
```


- This R function requires two inputs (or arguments), separated by a comma. The first input is the cell range reference. The second input is the desired percentile.
