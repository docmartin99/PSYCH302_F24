...
```
__NOTE__:  The `!=` is read "not equal to", and is a common [logical operator](../R_Resources/Filter.qmd#Choosing-Rows##Logical-Operators) used in computer programming.  So the above code returns a subset of the original data omitting the rows.
