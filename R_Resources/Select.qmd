...
```
<a href="https://raw.githubusercontent.com/byuistats/Math221D_Course/main/Student_Work/R_Resources/Select.qmd" download="Select.qmd" type="text/markdown" download class="button-download">
    Download QMD
</a>
...
1. Click to see how to [filter](../R_Resources/Filter.qmd) out Ambitextrous participants and reaction time outliers (reaction times less than 1 seconds):
