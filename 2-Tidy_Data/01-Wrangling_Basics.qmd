...
We would begin with the raw data, "pipe" it into the `filter()` function and tell R what I want it to do.  I can either tell are what I want to keep or what I want to discard (more [here](../2-Tidy_Data/02-Filter.qmd)):
