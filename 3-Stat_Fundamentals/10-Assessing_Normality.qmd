...
```
<a href="https://raw.githubusercontent.com/byuistats/Math221D_Course/main/Student_Work/Workbooks/Assessing_Normality.qmd" download="Assessing_Normality.qmd" type="text/markdown" download class="button-download">
    Download QMD
</a>
...
All of the examples below are histograms of random samples from actual normal distributions:
