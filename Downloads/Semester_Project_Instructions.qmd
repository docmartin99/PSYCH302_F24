...
<div id="download-container">
  <a href="./Downloads/Semester_Project_Instructions.qmd" download="./Downloads/Semester_Project_Instructions.qmd" type="text/markdown" download class="button-download">
    Download QMD
  </a>
</div>
...
Knit your RMD file to produce a nice looking html report.  Submit the .html file into Canvas.  Be sure to check the following:
