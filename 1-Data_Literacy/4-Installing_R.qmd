...
```
<a href="https://raw.githubusercontent.com/byuistats/Math221D_Course/main/Student_Work/Workbooks/Installing_R.qmd" download="Installing_R.qmd" type="text/markdown" download class="button-download">
    Download QMD
</a>
...
Throughout this course, you will download many files. The collection of files will be a valuable resource if you go on to use R in the future.
  ...
  2. Download the [TestingTesting.qmd](https://github.com/byuistats/Math221D_Course/raw/main/Textbook/TestingTesting.qmd) file and save it into your folder. 
