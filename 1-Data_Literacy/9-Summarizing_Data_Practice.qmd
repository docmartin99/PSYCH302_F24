...
```
<a href="https://raw.githubusercontent.com/byuistats/Math221D_Course/main/Student_Work/Workbooks/Summarizing_Data_Multiple_Groups.qmd" download="Summarizing_Data_Practice.qmd" type="text/markdown" download class="button-download">
    Download QMD
</a>
...
#wordle <- read_csv('Data/Wordle.csv')
