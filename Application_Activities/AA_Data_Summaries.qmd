...
```
<a href="https://raw.githubusercontent.com/byuistats/Math221D_Course/main/Downloads/Application_Activities/AA_Data_Summaries.qmd" class="button-download" onclick="forceDownload(event, this)">
    Download QMD
</a>
...
<script>
  function forceDownload(event, link) {
    ...
    a.href = link.href;
    a.download = 'AA_Data_Summaries.qmd';
